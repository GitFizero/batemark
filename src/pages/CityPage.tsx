...
const CityPage = () => {
  ...
  const localBusinessSchema = {
    ...
    "url": `https://batemark.fr/meta-ads-${cityData.slug}`,
    "areaServed": {
      "@type": "City",
      "name": cityData.name,
      "containedInPlace": {
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://batemark.fr/meta-ads-${cityData.slug}`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`${cityData.metaTitle} - BATEMARK`} />
        <meta property="og:description" content={cityData.metaDescription} />
        <meta property="og:url" content={`https://batemark.fr/meta-ads-${cityData.slug}`} />
